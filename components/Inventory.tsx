...
export default function Inventory({ products, setProducts, categories }: any) {
  ...
  const sell = (id: string) => {
    ...
    const confirmSell = confirm(`Sell 1 unit of ${product.name}?`);
  ...
  return (
    <div>
      ...
      <button onClick={save} className="btn-primary mb-6 flex items-center gap-2">
        <Plus size={20} />
        Add Product
      </button>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="bg-gray-900 p-6 rounded-2xl w-100">
